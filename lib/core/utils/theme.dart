...
class CustomColor {
  ...
  static const Color green = Color(0xFF77af14);
  static const Color dark_blue = Color(0xFF1F4F59);
  static const Color dark_blue_transpercy = Color(0xCC1F4F59);
  static const Color light_blue = Color(0xFF54c0cc);
...
class CustomTheme {
  static ThemeData mainTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      subtitle1: TextStyle(fontSize: 16.0, color: CustomColor.fontBlack),
      subtitle2: TextStyle(fontSize: 16.0, color: CustomColor.hintColor),
      button: TextStyle(
        color: CustomColor.white,
        fontFamily: 'Roboto',
